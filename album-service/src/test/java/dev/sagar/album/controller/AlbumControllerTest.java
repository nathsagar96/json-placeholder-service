...
class AlbumControllerTest {
  ...
  void testGetAlbums_whenServiceReturnsAlbums_thenReturnAlbums() {
    // given
    List<Album> albums = Arrays.asList(new Album(1, "Title 1", 1), new Album(2, "Title 2", 2));
  ...
  void testGetAlbumsByUserId_whenServiceReturnsAlbums_thenReturnAlbums() {
    // given
    List<Album> albums = Arrays.asList(new Album(1, "Title 1", 1), new Album(2, "Title 2", 1));
